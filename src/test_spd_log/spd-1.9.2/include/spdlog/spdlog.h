...
// ---------------added by bigaoxian@trunk.tech
template<typename... Args>
inline void trace(spdlog::source_loc&& loc,fmt::format_string<Args...> fmt, Args &&...args)
{
    default_logger_raw()->trace(loc, fmt, std::forward<Args>(args)...);
}
...
template<typename... Args>
inline void debug(spdlog::source_loc&& loc,fmt::format_string<Args...> fmt, Args &&...args)
{
    default_logger_raw()->debug(loc, fmt, std::forward<Args>(args)...);
}
...
template<typename... Args>
inline void info(spdlog::source_loc&& loc,fmt::format_string<Args...> fmt, Args &&...args)
{
    default_logger_raw()->info(loc, fmt, std::forward<Args>(args)...);
}
...
template<typename... Args>
inline void warn(spdlog::source_loc&& loc,fmt::format_string<Args...> fmt, Args &&...args)
{
    default_logger_raw()->warn(loc, fmt, std::forward<Args>(args)...);
}
...
template<typename... Args>
inline void error(spdlog::source_loc&& loc,fmt::format_string<Args...> fmt, Args &&...args)
{
    default_logger_raw()->error(loc, fmt, std::forward<Args>(args)...);
}
...
template<typename... Args>
inline void critical(spdlog::source_loc&& loc,fmt::format_string<Args...> fmt, Args &&...args)
{
    default_logger_raw()->critical(loc, fmt, std::forward<Args>(args)...);
}
