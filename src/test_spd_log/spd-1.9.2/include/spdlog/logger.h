...
#define CREATE_SOURCE_LOC spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}
...
public:
    ...
    // ---------------added by bigaoxian@trunk.tech
    template<typename... Args>
    void trace(spdlog::source_loc& loc, fmt::format_string<Args...> fmt, Args &&...args)
    {
    ...
    template<typename... Args>
    void debug(spdlog::source_loc& loc, fmt::format_string<Args...> fmt, Args &&...args)
    {
    ...
    template<typename... Args>
    void info(spdlog::source_loc& loc, fmt::format_string<Args...> fmt, Args &&...args)
    {
    ...
    template<typename... Args>
    void warn(spdlog::source_loc& loc, fmt::format_string<Args...> fmt, Args &&...args)
    {
        log(loc, level::warn, fmt, std::forward<Args>(args)...);
    }
    ...
    template<typename... Args>
    void error(spdlog::source_loc& loc, fmt::format_string<Args...> fmt, Args &&...args)
    {
    ...
    template<typename... Args>
    void critical(spdlog::source_loc& loc, fmt::format_string<Args...> fmt, Args &&...args)
    {
        log(loc, level::critical, fmt, std::forward<Args>(args)...);
    }
